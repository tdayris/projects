This file contains TPM counts. TMP counts are normalized counts : you can compare counts between multiple samples, and between genes within a single sample.
